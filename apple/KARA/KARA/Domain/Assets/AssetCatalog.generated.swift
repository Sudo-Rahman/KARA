// Generated from shared/asset-catalog.json by scripts/generate-asset-catalog.mjs.
...
extension AssetPresetCompatibility {
    nonisolated static let weightRelativeTolerance: Double = 0.01
    nonisolated static let weightAbsoluteTolerance: Double = 0.01
    nonisolated static let finenessRelativeTolerance: Double = 0.002
    nonisolated static let finenessAbsoluteTolerance: Double = 1
}
