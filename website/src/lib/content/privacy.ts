		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'En l’absence de connexion, Kara peut utiliser le modèle local de l’appareil ; le média ne quitte alors pas l’application.'
				],
				note:
		...
		sections: [
			...
			},
			{
				...
				paragraphs: [
					...
					'When no connection is available, Kara may use the device’s local model; the media then stays inside the app.'
				],
				note:
